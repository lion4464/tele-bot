...
import com.example.telegrambot.exceptions.TokenExpiredException;
import com.example.telegrambot.revoke_access_token.RevokeAccessTokenService;
import com.example.telegrambot.revoke_refresh_token.RevokeRefreshTokenService;
...
public class JWTokenUtil implements TokenUtil{
    ...
    public void revokeTokens(String accessToken, String refreshToken) {
        if(!isTokenExpired(accessToken)){
            ...
            UUID id = UUID.fromString(claims.get("sub").toString());
